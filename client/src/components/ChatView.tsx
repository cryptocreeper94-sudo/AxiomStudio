...
function MessageBubble({ msg, agentName, onApply, activeFileName }: {
  ...
  const modelShort = msg.model?.includes("claude-fable") ? "Claude Fable 5"
    ...
    : msg.model?.includes("gemini-2.0-flash") ? "Gemini Flash"
    : msg.model?.includes("gemini-3") ? "Gemini Pro"
    : msg.model?.includes("gpt-4.1-mini") ? "GPT-4.1 Mini"
    : msg.model?.includes("gpt-4.1") ? "GPT-4.1"
